...
This guide describes the Android and iOS/iPadOS **0.2.0 (41)** private-beta
...
When build 41 is distributed, confirm the opening Talk status card says
**Version 0.2.0 (41)**. If it shows an older build, return to TestFlight or
