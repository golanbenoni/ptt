...
This guide describes the Android and iOS/iPadOS **0.2.0 (34)** private-beta
...
When build 34 is distributed, confirm the opening Talk status card says
**Version 0.2.0 (34)**. If it shows an older build, return to TestFlight or
