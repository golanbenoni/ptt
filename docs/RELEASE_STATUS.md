...
This page is the concise distribution record for the PTT Talk **0.2.0 (41)**
...
| --- | --- | --- |
| iOS/iPadOS | TestFlight · `PTT Internal Testers` | Build 37 was uploaded and processed, but its internal-group association did not pass automated verification; synchronized build `0.2.0 (41)` is pending exact-commit gates |
| Android | Google Play · Internal testing | `0.2.0 (37)` available; synchronized build `0.2.0 (41)` is pending exact-commit gates |
...
protocol-level heartbeats; no build 40 soak evidence is carried forward.
...
soak, and independent review have not all passed. Release **0.2.0 (41)**
...
Candidate build 41 records its tested source commit and signed artifact hashes
...
tied to the Git commit and workspace state. Build 41 remains a candidate until
...
independent-review gates for 0.2.0 (41).
...
## Required automated evidence for build 41
...
After updating, confirm the opening status card reports **Version 0.2.0 (41)**.
