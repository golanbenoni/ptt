...
This page is the concise distribution record for the PTT Talk **0.2.0 (34)**
...
| --- | --- | --- |
| iOS/iPadOS | TestFlight · `PTT Internal Testers` | `0.2.0 (34)` internal candidate; production promotion gated |
| Android | Google Play · Internal testing | `0.2.0 (34)` internal candidate; production promotion gated |
...
Build 33 was accepted by App Store Connect's binary uploader but did not become
visible to the internal TestFlight group. It is superseded by build 34. The iOS
...
soak, and independent review have not all passed. Release **0.2.0 (34)**
...
Candidate build 34 records its tested source commit and signed artifact hashes
...
tied to the Git commit and workspace state. Build 34 remains a candidate until
...
independent-review gates for 0.2.0 (34).
...
## Required automated evidence for build 34
...
After updating, confirm the opening status card reports **Version 0.2.0 (34)**.
