...
This page is the concise distribution record for the PTT Talk **0.2.0 (45)**
...
| --- | --- | --- |
| iOS/iPadOS | TestFlight · `PTT Internal Testers` | Build 37 was uploaded and processed, but its internal-group association did not pass automated verification; synchronized build `0.2.0 (45)` is pending exact-commit gates |
| Android | Google Play · Internal testing | `0.2.0 (37)` available; synchronized build `0.2.0 (45)` is pending exact-commit gates |
...
sonification stream for acoustic measurement. Build 45 adds the conversation-
first interface, encrypted thread controls, global search, saved items, and
pairwise-encrypted ephemeral typing indicators. No earlier candidate evidence
is carried forward to its exact-commit release decision.
...
soak, and independent review have not all passed. Release **0.2.0 (45)**
...
Candidate build 45 records its tested source commit and signed artifact hashes
...
tied to the Git commit and workspace state. Build 45 remains a candidate until
...
independent-review gates for 0.2.0 (45).
...
## Required automated evidence for build 45
...
After updating, confirm the opening status card reports **Version 0.2.0 (45)**.
