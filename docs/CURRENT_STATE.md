...
| Interface | Four stable destinations (Home, Calls, Activity, You), conversation-first Home with local search and All/Unread/Mentions filters, persistent contextual PTT control, expandable radio console, active-call banner, and progressive disclosure for setup/security details | Implemented on Android and iOS in `codex/conversation-first-home`; not yet distributed |
