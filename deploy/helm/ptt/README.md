...
This chart is the supported self-hosted deployment target for PTT Talk 0.1.23
(26), protocol 1.1. One Helm release is one private-team instance. It installs the control
