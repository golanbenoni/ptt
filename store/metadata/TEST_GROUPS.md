...
candidate 0.1.23 (26). Assign the build only after the same commit passes the
...
- Release notes: Private production-voice beta with real Opus audio, SFrame
  ...
  notes, video, reactions, replies, and delivery receipts. Build 26 also fixes
  rapid hold/release sequencing, preserves Apple's system-owned audio graph,
  and enables reliable push-assisted background reconnect.
