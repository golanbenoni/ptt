...
This is the synchronized internal-test configuration for **0.2.0 (38)**.
...
- Release notes: Private production-voice beta with real Opus audio, SFrame
  ...
  notes, video, reactions, replies, and delivery receipts. Build 38 adds encrypted
