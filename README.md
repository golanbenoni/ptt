...
participants. That work is the **0.2.0 (38)** internal candidate. Internal
...
The next internal-testing candidate is **0.2.0 (build 38)** on product protocol
...
**private beta**, not a general-production release. Candidate build 38 must pass
