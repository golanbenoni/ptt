...
participants. That work is the **0.2.0 (42)** internal candidate. Internal
...
The next internal-testing candidate is **0.2.0 (build 42)** on product protocol
...
**private beta**, not a general-production release. Candidate build 42 must pass
