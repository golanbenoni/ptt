...
participants. That work is the **0.2.0 (45)** internal candidate. Internal
...
The next internal-testing candidate is **0.2.0 (build 45)** on product protocol
...
**private beta**, not a general-production release. Candidate build 45 must pass
