/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=staging` (hash: 6aba52376f656267e8aa543c2e1c9443)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "ChannelCoordinator";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "EMAIL_FROM" | "PUBLIC_BASE_URL" | "APNS_ENVIRONMENT" | "ANDROID_APP_CERT_SHA256">> {}
}
