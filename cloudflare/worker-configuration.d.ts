/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=staging` (hash: 03371b377391c1a5782697e5333dd412)
...
interface __BaseEnv_Env {
	...
	CHANNELS: DurableObjectNamespace<import("./src/index").ChannelCoordinator>;
	CALL_EVENTS: DurableObjectNamespace<import("./src/index").CallEventCoordinator>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ChannelCoordinator" | "CallEventCoordinator";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "EMAIL_FROM" | "PUBLIC_BASE_URL" | "ANDROID_APP_CERT_SHA256">> {}
}
